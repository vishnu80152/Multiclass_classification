...
conv_layers = [3]
neurons = [64]
# "output layer is how much number of class are give to the model."
output_layer=6
...
#saving the model so that while we use the model we need to compile it again and again
model.save("allclasifier.h5")